...
<div id="carrito" style="display: none; position: fixed; top: 50px; left: 50%; transform: translateX(-50%); width: 400px; max-height: 80%; overflow-y: auto; background-color: #f9f9f9; border: 1px solid #ccc; border-radius: 8px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); z-index: 1000;">
    ...
    <img src="{{ asset('img/TN1.jpeg') }}" alt="Producto 1" style="width: 50%; height: auto; border-radius: 20px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Tenis de Corredor $150</p>
        <div>
    ...
    <!-- Imagen 2 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/TN2.jpeg') }}" alt="Producto 2" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Tenis Personales $200</p>
        <div>
...
<!-- Imagen 3 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/TN3.jpeg') }}" alt="Producto 3" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Tenis de Cholos $250</p>
        <div>
...
<!-- Imagen 4 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/TN4.jpeg') }}" alt="Producto 4" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Tenis de Viaje $160</p>
        <div>
...
<!-- Imagen 5 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/TN5.jpeg') }}" alt="Producto 5" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Tenis para deporte $120</p>
        <div>
...
<!-- Imagen 6 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/TN6.jpg') }}" alt="Producto 6" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Tenis de playa $100</p>
        <div>
...
<script>
    ...
    $('#agregarAlCarrito1').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Tenis de Corredor</p>
    ...
    $('#agregarAlCarrito2').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Tenis Personales</p>
            <p class="precio-producto">$200</p>
            <img src="{{ asset('img/TN2.jpeg') }}" alt="Producto 2" style="width: 50%; height: auto; border-radius: 20px;">
        `;
    ...
    $('#agregarAlCarrito3').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Tenis de Cholos</p>
            <p class="precio-producto">$250</p>
            <img src="{{ asset('img/TN3.jpeg') }}" alt="Producto 3" style="width: 50%; height: auto; border-radius: 20px;">
        `;
    ...
    $('#agregarAlCarrito4').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Tenis de Viaje</p>
            <p class="precio-producto">$160</p>
            <img src="{{ asset('img/TN4.jpeg') }}" alt="Producto 4" style="width: 50%; height: auto; border-radius: 20px;">
        `;
    ...
    $('#agregarAlCarrito5').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Tenis para deporte</p>
            <p class="precio-producto">$120</p>
            <img src="{{ asset('img/TN5.jpeg') }}" alt="Producto 5" style="width: 50%; height: auto; border-radius: 20px;">
        `;
    ...
    $('#agregarAlCarrito6').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Tenis de playa</p>
            <p class="precio-producto">$100</p>
            <img src="{{ asset('img/TN6.jpeg') }}" alt="Producto 6" style="width: 50%; height: auto; border-radius: 20px;">
        `;
