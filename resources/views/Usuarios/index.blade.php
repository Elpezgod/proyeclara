...
@section('content_header')
    <h2 class="text-center"><b>TRABAJADORES</b></h2>
@stop
        ...
        <div class="card-header container" >
            <div class="row">
                <div class="col-lg-6 col-mb-6 col-sm-12">
                    <a href="{{route('usuarios.create')}}" class="btn btn-primary"><b>Agregar trabajador</b></a>
                </div>
                <div class="col-lg-6 col-mb-6 col-sm-12">
            ...
            <tbody>
                @foreach ($usuarios as $usuarios)
                    <tr>
                        ...
                        <td width="2px">
                            <a href="{{route('usuarios.show', $usuarios)}}" class="btn btn-primary btn-sm mb-2">Mostar</a>
                        </td>
                        <td width="5px">
                            <a href="{{route('usuarios.edit', $usuarios)}}" class="btn btn-primary btn-sm mb-2">Editar</a>
                        </td>
                        <td width="5px">
