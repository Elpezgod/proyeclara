...
@section('content_header')
    <h2 class="text-center"><b>AGREGAR TRABAJADOR</b></h2>
@stop
        ...
        <div class="card-body">
            <form method="POST" action="{{route('usuarios.store')}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="departament []" class="form-control js-example-basic-multiple" multiple="multiple" required>
                ...
                <div class="text-center">
                    <input type="submit" value="Crear trabajador" class="btn btn-primary">
