...
<div class="interaction-bar-left">
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="{{ url('/Playeras') }}">Playera</a>
            <!-- <a href="{{ url('/Zapatos') }}">Zapatos</a> -->
            <a href="{{ url('/Pantalones') }}"style="background-color: pink; color: black;">Pantalones</a>
...
<div id="carrito" style="display: none; position: fixed; top: 50px; left: 50%; transform: translateX(-50%); width: 400px; max-height: 80%; overflow-y: auto; background-color: #f9f9f9; border: 1px solid #ccc; border-radius: 8px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); z-index: 1000;">
 ...
 <div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/PA1.jpg') }}" alt="Producto 1" style="width: 50%; height: auto; border-radius: 20px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Pantalon de Caballero Beige $250</p>
        <div>
    ...
    <!-- Imagen 2 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/PA2.jpg') }}" alt="Producto 2" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Pantalon de Vestir $300</p>
        <div>
...
<!-- Imagen 3 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/PA3.jpg') }}" alt="Producto 3" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Pantalo de Mezclilla $250</p>
        <div>
...
<!-- Imagen 4 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/PA.jpg') }}" alt="Producto 4" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Pantalon Negro Dama $250</p>
        <div>
...
<!-- Imagen 5 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/PA5.jpg') }}" alt="Producto 5" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Pantalon Negro Vestir $300</p>
        <div>
...
<!-- Imagen 6 -->
<div style="flex: 0 0 calc(33.33% - 20px); margin-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
    <img src="{{ asset('img/PA6.jpg') }}" alt="Producto 6" style="width: 50%; height: auto; border-radius: 10px;">
    <div style="padding: 10px; text-align: center;">
        <p style="margin-bottom: 10px; font-weight: bold;">Pantalon Negro Entubado $350</p>
        <div>
...
<script>
    ...
    $('#agregarAlCarrito1').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Pantalon de Caballero Beige</p>
            <p class="precio-producto">$250</p>
            <img src="{{ asset('img/PA1.jpg') }}" alt="Producto 1" style="width: 50%; height: auto; border-radius: 20px;">
        `;
        agregarProductoAlCarrito(productoHTML, 250);
    });

    $('#agregarAlCarrito2').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Pantalon de Vesti</p>
            <p class="precio-producto">$300</p>
            <img src="{{ asset('img/PA2.jpg') }}" alt="Producto 2" style="width: 50%; height: auto; border-radius: 20px;">
        `;
        agregarProductoAlCarrito(productoHTML, 300);
    });

    $('#agregarAlCarrito3').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Pantalo de Mezclilla</p>
            <p class="precio-producto">$250</p>
            <img src="{{ asset('img/PA3.jpg') }}" alt="Producto 3" style="width: 50%; height: auto; border-radius: 20px;">
        `;
        agregarProductoAlCarrito(productoHTML, 250);
    });
    ...
    $('#agregarAlCarrito4').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Pantalon Negro Dama</p>
            <p class="precio-producto">$250</p>
            <img src="{{ asset('img/PA4.jpg') }}" alt="Producto 4" style="width: 50%; height: auto; border-radius: 20px;">
        `;
        agregarProductoAlCarrito(productoHTML, 250);
    });
    ...
    $('#agregarAlCarrito5').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Pantalon Negro Vestir</p>
            <p class="precio-producto">$300</p>
            <img src="{{ asset('img/PA5.jpg') }}" alt="Producto 5" style="width: 50%; height: auto; border-radius: 20px;">
        `;
        agregarProductoAlCarrito(productoHTML, 300);
    });
    ...
    $('#agregarAlCarrito6').on('click', function() {
        const productoHTML = `
            <p class="nombre-producto" style="margin-bottom: 10px; font-weight: bold;">Pantalon Negro Entubado</p>
            <p class="precio-producto">$350</p>
            <img src="{{ asset('img/PA6.jpg') }}" alt="Producto 6" style="width: 50%; height: auto; border-radius: 20px;">
        `;
        agregarProductoAlCarrito(productoHTML, 350);
    });
